...
if __name__ == "__main__":
    ...
    my_block_attn_output = engine.model.blocks[0].att(my_block_ln1_output)
    hf_block_attn_output = hf_model.transformer.h[0].attn(hf_block_ln1_output)[0]
    print(my_block_attn_output.dtype,hf_block_attn_output.dtype)
    print(torch.allclose(my_block_attn_output,hf_block_attn_output,rtol=1e-05))#attn输出不一致